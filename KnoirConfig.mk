...
COMMON_PATH := device/motorola/knoir
...
TARGET_KERNEL_SOURCE := kernel/motorola/knoir
TARGET_KERNEL_CONFIG := vendor/holi-qgki_defconfig vendor/ext_config/knoir.config
...
include vendor/motorola/knoir/BoardConfigVendor.mk
